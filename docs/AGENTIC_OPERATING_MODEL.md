...
| **Claude Code** | Second product lane in parallel (`claude/*`), local long refactors, same gates/manifest as Cursor | Same `repoPath` as an active Cursor PR without handoff; HISE export on Linux |
