...
| **Claude Code** | **SP-1200 VST** (`SP1200/`), **Pluggnb Vital pack** (`disklordz/packs/vital/`), other `claude/*` | Same `repoPath` as active Cursor PR without handoff; HISE export on Linux |
