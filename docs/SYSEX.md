...
| Tone A TVA / TVF envelope times & sustain | global `amp*` / `filter*` ADSR |

Unmapped JD fields (LFO, per-tone envelope offsets B–D, coupling, multisample) keep current values or factory defaults.
