...
CURATED: list[dict] = [
    ...
    # --- Funk / 80s / Screw / Talkbox (curated) ---
    _snap(
        "025 P-Funk Parliament Stack",
        [0.92, 0.78, 0.62],
        [0, 0, 0],
        [1, 2, 2],
        [0, 11, -9],
        ...
        0.78,
        0.42,
        (0.006, 0.28, 0.32, 0.45),
        (0.004, 0.22, 0.92, 0.38),
        0.32,
        0,
        0.06,
        0.09,
    ...
    _snap(
        ...
        0.72,
        0.38,
        (0.012, 0.35, 0.38, 0.55),
        (0.008, 0.28, 0.94, 0.48),
        0.45,
        0.02,
        0.08,
        0.14,
    ...
    _snap(
        ...
        0.88,
        0.46,
        (0.002, 0.11, 0.12, 0.28),
        (0.001, 0.09, 0.82, 0.22),
        0.55,
        0,
        0.10,
        0.05,
    ...
    _snap(
        ...
        0.42,
        0.52,
        (0.018, 0.38, 0.45, 0.55),
        (0.012, 0.32, 0.90, 0.50),
        0.22,
        0,
        0.04,
        0.07,
    ...
    _snap(
        ...
        0.74,
        0.62,
        (0.004, 0.16, 0.48, 0.35),
        (0.003, 0.14, 0.88, 0.32),
        0.48,
        0.03,
        0.11,
        0.18,
    ...
    _snap(
        ...
        0.38,
        0.28,
        (0.025, 0.65, 0.35, 1.20),
        (0.080, 0.55, 0.96, 1.50),
        0.10,
        0,
        0.22,
        0.42,
    ...
    _snap(
        "031 Roger Troutman Talkbox Lead",
        [0.62, 0.78, 0.44],
        [3, 1, 1],
        [2, 2, 3],
        [0, 7, -5],
        ...
        0.94,
        0.55,
        (0.008, 0.14, 0.22, 0.25),
        (0.006, 0.12, 0.86, 0.28),
        4.5,
        0.06,
        0.55,
        0.10,
    ...
    _snap(
        ...
        0.90,
        0.40,
        (0.006, 0.16, 0.18, 0.30),
        (0.004, 0.14, 0.90, 0.32),
        3.8,
        0.05,
        0.48,
        0.08,
...
# Archetypes for programs 033–300 (includes funk / 80s / talkbox / screw variants)
ARCHETYPES: list[tuple[str, dict]] = [
    ("P-Funk Parliament", _snap("", [0.90, 0.76, 0.58], [0, 0, 0], [1, 2, 2], [0, 10, -8], 0.04, 2.8, 700, 0.56, 2.1, 0.76, 0.40, (0.006, 0.26, 0.30, 0.42), (0.004, 0.20, 0.91, 0.36), 0.30, 0, 0.06, 0.08, 2.0)),
    ("Funkadelic Bootsy", _snap("", [0.86, 0.70, 0.52], [0, 2, 0], [1, 2, 2], [0, -7, 11], 0.05, 2.7, 560, 0.50, 2.0, 0.70, 0.36, (0.010, 0.32, 0.36, 0.50), (0.008, 0.26, 0.93, 0.45), 0.42, 0.02, 0.07, 0.12, 2.3)),
    ("80s Boogie Bass", _snap("", [0.88, 0.56, 0.26], [0, 1, 0], [2, 2, 2], [0, 5, -3], 0.03, 2.3, 800, 0.52, 1.9, 0.86, 0.44, (0.002, 0.10, 0.10, 0.26), (0.001, 0.08, 0.80, 0.20), 0.50, 0, 0.09, 0.04, 1.6)),
    ("80s R&B Bass", _snap("", [0.80, 0.50, 0.36], [2, 0, 0], [2, 2, 1], [0, 3, -2], 0.014, 1.8, 600, 0.30, 1.4, 0.40, 0.50, (0.016, 0.36, 0.42, 0.52), (0.010, 0.30, 0.88, 0.48), 0.20, 0, 0.04, 0.06, 1.0)),
    ("80s Synth Lead", _snap("", [0.72, 0.60, 0.46], [0, 1, 1], [2, 2, 3], [0, 8, -6], 0.02, 2.2, 4600, 0.44, 1.5, 0.72, 0.60, (0.004, 0.15, 0.46, 0.34), (0.003, 0.13, 0.87, 0.30), 0.46, 0.03, 0.10, 0.16, -1.0)),
    ("DJ Screw Sub", _snap("", [0.96, 0.40, 0.20], [0, 0, 0], [1, 1, 2], [0, 0, 4], 0.06, 2.5, 250, 0.46, 2.2, 0.36, 0.26, (0.022, 0.60, 0.32, 1.10), (0.070, 0.50, 0.95, 1.40), 0.09, 0, 0.20, 0.38, 3.2)),
    ("Troutman Talkbox", _snap("", [0.60, 0.76, 0.42], [3, 1, 1], [2, 2, 3], [0, 6, -4], 0.02, 2.35, 2000, 0.48, 1.6, 0.92, 0.52, (0.007, 0.13, 0.20, 0.24), (0.005, 0.11, 0.85, 0.26), 4.2, 0.06, 0.52, 0.09, -0.5)),
    ("Zapp Talkbox Bass", _snap("", [0.84, 0.68, 0.38], [3, 1, 0], [2, 2, 1], [0, 4, 0], 0.024, 2.25, 460, 0.44, 1.85, 0.88, 0.38, (0.005, 0.15, 0.16, 0.28), (0.004, 0.13, 0.89, 0.30), 3.6, 0.05, 0.45, 0.07, 2.0)),
