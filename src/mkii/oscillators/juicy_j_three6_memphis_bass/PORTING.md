# mkII port: juicy_j_three6_memphis_bass
...
1. Open v1 source: `src/oscillators/memphis-juicy/juicy_bass.cc`
...
6. Build: `../../tools/build-mkii.sh juicy_j_three6_memphis_bass`
