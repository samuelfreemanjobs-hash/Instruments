#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/sh101-babyface/sh101_bass.cc
...
public:
  ...
  struct Params {
    ...
    void reset() {
      ...
      p1 = param_10bit_to_f32(491);
      p2 = param_10bit_to_f32(563);
      p3 = param_10bit_to_f32(184);
      p4 = param_10bit_to_f32(123);
      p5 = param_10bit_to_f32(225);
      p6 = param_10bit_to_f32(102);
      p7 = param_10bit_to_f32(409);
      p8 = param_10bit_to_f32(368);
    }
    Params() { reset(); }
  };
