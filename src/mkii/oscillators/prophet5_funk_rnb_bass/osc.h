#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/prophet-funk/prophet_bass.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(225);
      p1 = param_10bit_to_f32(634);
      p2 = param_10bit_to_f32(358);
      p3 = param_10bit_to_f32(430);
      p4 = param_10bit_to_f32(286);
      p5 = param_10bit_to_f32(184);
      p6 = param_10bit_to_f32(82);
      p7 = param_10bit_to_f32(327);
      p8 = param_10bit_to_f32(307);
    }
    Params() { reset(); }
  };
