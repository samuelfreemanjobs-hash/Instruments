#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/moog-voyager-se/voyager_se.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(286);
      p1 = param_10bit_to_f32(593);
      p2 = param_10bit_to_f32(358);
      p3 = param_10bit_to_f32(491);
      p4 = param_10bit_to_f32(327);
      p5 = param_10bit_to_f32(225);
      p6 = param_10bit_to_f32(256);
      p7 = param_10bit_to_f32(102);
      p8 = param_10bit_to_f32(430);
    }
    Params() { reset(); }
  };
