#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/sub-phatty/sub_phatty.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(409);
      p1 = param_10bit_to_f32(563);
      p2 = param_10bit_to_f32(225);
