#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/larry-june/larry_bass.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(450);
      p1 = param_10bit_to_f32(532);
      p2 = param_10bit_to_f32(471);
      p3 = param_10bit_to_f32(491);
      p4 = param_10bit_to_f32(512);
      p5 = param_10bit_to_f32(593);
      p6 = param_10bit_to_f32(205);
      p7 = param_10bit_to_f32(471);
      p8 = param_10bit_to_f32(512);
    }
    Params() { reset(); }
  };
