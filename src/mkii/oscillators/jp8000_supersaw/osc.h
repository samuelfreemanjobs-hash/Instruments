...
/*
 * Roland JP-8000–style supersaw for NTS-1 mkII (shared supersaw_core.h).
 */
#include "processor.h"
...
public:
  ...
  void reset() override final {
    ...
    env_stage_ = 0;
    gate_ = false;
    tune_ = supersaw_tuning_jp8000();
    detune_ = param_10bit_to_f32(614);
    voices_norm_ = param_10bit_to_f32(870);
    width_ = param_10bit_to_f32(532);
    sub_ = param_10bit_to_f32(368);
    tone_hp_ = tune_.hp_hz_default + 180.f;
    level_ = 0.85f;
    attack_sec_ = 0.008f;
    release_sec_ = 0.25f;
