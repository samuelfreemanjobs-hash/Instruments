#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/juno-rnb/juno_rnb.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(348);
      p1 = param_10bit_to_f32(737);
      p2 = param_10bit_to_f32(266);
      p3 = param_10bit_to_f32(450);
      p4 = param_10bit_to_f32(307);
      p5 = param_10bit_to_f32(102);
      p6 = param_10bit_to_f32(389);
      p7 = param_10bit_to_f32(368);
      p8 = param_10bit_to_f32(143);
    }
    Params() { reset(); }
  };
