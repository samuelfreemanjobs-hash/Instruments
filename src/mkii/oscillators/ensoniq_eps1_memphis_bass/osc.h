#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/ensoniq-eps1/eps_bass.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(593);
      p1 = param_10bit_to_f32(409);
      p2 = param_10bit_to_f32(532);
      p3 = param_10bit_to_f32(696);
      p4 = param_10bit_to_f32(460);
      p5 = param_10bit_to_f32(430);
      p6 = param_10bit_to_f32(256);
      p7 = param_10bit_to_f32(82);
