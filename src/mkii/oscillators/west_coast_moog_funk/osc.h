#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/west-coast-moog/funk_moog.cc
...
public:
  ...
  struct Params {
    ...
    void reset() {
      ...
      p1 = param_10bit_to_f32(389);
      p2 = param_10bit_to_f32(184);
      p3 = param_10bit_to_f32(246);
      p4 = param_10bit_to_f32(327);
      p5 = param_10bit_to_f32(123);
      p6 = param_10bit_to_f32(430);
      p7 = param_10bit_to_f32(358);
