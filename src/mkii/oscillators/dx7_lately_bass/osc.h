#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/dx7-lately/lately_bass.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(532);
      p1 = param_10bit_to_f32(634);
      p2 = param_10bit_to_f32(593);
      p3 = param_10bit_to_f32(491);
      p4 = param_10bit_to_f32(225);
      p5 = param_10bit_to_f32(61);
      p6 = param_10bit_to_f32(450);
      p7 = param_10bit_to_f32(368);
      p8 = param_10bit_to_f32(563);
    }
    Params() { reset(); }
  };
