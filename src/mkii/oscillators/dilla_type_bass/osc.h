#pragma once
/* mkII oscillator — PORT DSP from v1: oscillators/dilla-bass/dilla_bass.cc
...
public:
  ...
  struct Params {
    ...
    float p8;
    void reset() {
      p0 = param_10bit_to_f32(184);
      p1 = param_10bit_to_f32(532);
      p2 = param_10bit_to_f32(327);
      p3 = param_10bit_to_f32(696);
      p4 = param_10bit_to_f32(184);
      p5 = param_10bit_to_f32(164);
      p6 = param_10bit_to_f32(460);
      p7 = param_10bit_to_f32(491);
      p8 = param_10bit_to_f32(225);
    }
    Params() { reset(); }
  };
