...
| **HISE sketch lane** (rompler / sampler R&D) | [docs/HISE_SKETCH_LANE.md](docs/HISE_SKETCH_LANE.md) · [hise-sketch/ARCHITECTURE.md](hise-sketch/ARCHITECTURE.md) | HISE local export (Antigravity); not in root CMake |
