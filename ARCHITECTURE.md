...
| **DISKLORDZ ROMPLER** (sample-based rompler; in planning) | [docs/DISKLORDZ_ROMPLER_CURSOR_PROMPT.md](docs/DISKLORDZ_ROMPLER_CURSOR_PROMPT.md) | JUCE target TBD — `DisklordzRompler/` |
