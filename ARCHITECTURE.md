...
| **DisklordzSynth** (offline procedural engines — sellable WAV/DLROM tools) | [DisklordzSynth/ARCHITECTURE.md](DisklordzSynth/ARCHITECTURE.md) | `DisklordzSynth_RenderWav`, `DisklordzSynth_ExportWavPack`, `DisklordzSynth_BuildFactoryPack` |
