# WAVE-909 — Product Specification

## Product vision

WAVE-909 is a **sampleless** virtual instrument for trap, phonk, and dark cinematic production. It combines wavetable morphing inspired by high-end hybrid digital-analog synths with street-ready grit: diode-style saturation, bit reduction, and cassette wobble macros.
