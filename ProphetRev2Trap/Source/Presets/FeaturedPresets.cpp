...
constexpr FeaturedKey kFeatured[] = {
    ...
    { "Bass", "Wavephonk Grave" },
    { "Bass", "Wavephonk Stomp" },
    { "Bass", "Ambient Phonk Crawl" },
    { "Bass", "Cloud Phonk Pulse" },
    { "Bass", "Hardware Sub Drive" },
    { "Synth", "Night Circuit" },
    ...
    { "Synth", "Wave Dawn" },
    { "Synth", "Wave Shimmer" },
    { "Synth", "Vapor Trap Pulse" },
    { "Synth", "Vapor Trap Mist" },
    { "Synth", "Chillwave Pool" },
    { "Synth", "Chillwave Dim" },
    { "Synth", "Hardware Brass Stack" },
    { "Synth", "Ambient Phonk Choir" },
    ...
    { "Lead", "Wavephonk Chain" },
    { "Lead", "Wavephonk Ring" },
    { "Lead", "Vapor Trap Rise" },
    { "Lead", "Wave Glide" },
    { "Lead", "Cloud Phonk Wire" },
    { "Pad", "Mike Dean Haze" },
    { "Pad", "Dean Analog Pad" },
    ...
    { "Pad", "Wave Deep" },
    { "Pad", "Cloud Phonk Float" },
    { "Pad", "Chillwave Dust" },
    { "Pad", "Ambient Phonk Night" },
    { "Pad", "Vapor Trap Fade" },
    ...
    { "Pluck/Keys", "Wave Echo Keys" },
    { "Pluck/Keys", "Hardware Keys Pluck" },
    { "Pluck/Keys", "Vapor Trap Rim" },
};
